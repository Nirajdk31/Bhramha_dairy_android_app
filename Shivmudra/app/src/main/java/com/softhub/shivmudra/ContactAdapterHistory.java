...
//    }
    ...
    public void onBindViewHolder(@NonNull ContactAdapterHistory.ViewHolder holder, int position) {
        ...
        if(listItem.getOrder_status().equals("0")){
        ...
        }else if(listItem.getOrder_status().equals("1")){
            holder.order_date.setTextColor(R.color.colorPrimaryDark);
            holder.order_date.setText("Your order is accepted on "+listItem.getOrder_date());
...
//                Intent i = new Intent(context, CompleteOrderHistory.class);
//                i.putExtra("order_id", listItem.getOrder_id());
